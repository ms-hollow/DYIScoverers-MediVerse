...
const addMedicalHistory = () => {
    ...
    const [formData, setFormData] = useState({ 
        ...
        treatmentProcedure: [{noTP: 1, tp: '', tpDateStarted: '', tpDateEnd: '', tpDuration: ''}],
        test: [{noTest: 1, testType: '', orderingPhysician: '', testDate: '', reviewingPhysician: '', testResult: ''}],
        medication: [{noMedication: 1, medicationType: '', dateOfPrescription: '', medicationReviewingPhysician: '', medicationFrequency: '', medicationDuration: '', medicationEndDate: ''}],
                ...
                <form className={styles.medicalHistoryForm} onSubmit={handleSubmit}>   
                    ...
                    {formData.medication.map((medication, index) => (
                        <div className={styles.formRow} key={index}>
                            ...
                            <div className={styles.formFieldRow}>
                                <input type="text" id="medication-reviewing-physician"  name="medicationReviewingPhysician" placeholder="Ordering Physician" required onChange={(e) => handleChange(e, index)}/>
                            </div>
                            <div className={styles.formFieldRow}>
